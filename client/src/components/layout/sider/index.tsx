            ...
            <ListItemButton
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  "&:hover": {
                    backgroundColor: 
                    //check if we have currently selected the item. If so change color to be #1e36e8
      ...
      >
        <Drawer
          ...
          sx={{
            ...
            "& .MuiDrawer-paper": {
              width: 256,
              bgcolor: "#fcfcfc", //was secondary.main. This is the color of the drawer that we see when we change the layout to mobile
            },
          }}
        >
          <Box
        ...
        <Drawer
          variant="permanent"
          PaperProps={{ elevation: 0 }} //was 1 for elevation shadow
          sx={{
